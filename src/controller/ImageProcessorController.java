...
//    ImageManipulation manipulation=model;
//    ImageGenerator generator=model;
...
//          manipulation = factory.getManipulation(img);
////          manipulationCommand.process(manipulation);
////          generator=factory.getManipulation(img);
//          break;
//        case "mosaic":
...
//          model =factory.getGeneration(width, (2 * width) / 3);
